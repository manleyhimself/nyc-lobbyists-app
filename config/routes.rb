NycLobbyistsApp::Application.routes.draw do
  
  get '/lobbyists', to: 'lobbyists#index'

  get '/lobbyists/:id', to: 'lobbyists#show', as: 'lobbyist'

  get '/firms', to: 'firms#index'

  get '/firms/:id', to: 'firms#show', as: 'firm'
