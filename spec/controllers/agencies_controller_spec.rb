  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved agency as @agency" do
        ...
        post :create, {:agency => { "name" => "invalid value" }}, valid_session
        assigns(:agency).should be_a_new(Agency)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested agency" do
        ...
        Agency.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => agency.to_param, :agency => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the agency as @agency" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Agency.any_instance.stub(:save).and_return(false)
        put :update, {:id => agency.to_param, :agency => { "name" => "invalid value" }}, valid_session
        assigns(:agency).should eq(agency)
      end
